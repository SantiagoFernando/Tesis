            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                  ...
                  <form name="formularioS" action="<?php echo base_url(); ?>personas/ctadmin/fsave" method="post">
                    <div class="tab-content">
                      ...
                      <div class="tab-pane active" id="datos_generales">
                        ...
                        <!--Inicio 1ra fila-->
                        <div class="row">
                          <div class="form-group col-sm-6 <?php echo (form_error("txtapellido")) ? 'has-error' : ''; ?>">
                            <label for="txtapellido">Apellido</label>
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-user"></i></span>
                              <input type="text" id="txtapellido" name="txtapellido" value="<?php echo set_value("txtapellido") ?>" class="form-control" onkeypress="return sololetras(event)" onpaste="return false;" onkeyup="mayus(this);" placeholder="Apellidos">
                            </div>
                          ...
                          <div class="form-group col-sm-6  <?php echo (form_error("txtnombre")) ? 'has-error' : ''; ?>">
                            ...
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-user"></i></span>
                              <input type="text" id="txtnombre" name="txtnombre" name="txtapellido" value="<?php echo set_value("txtnombre") ?>" class="form-control" placeholder="Nombre" onkeypress="return sololetras(event)" onkeyup="mayus(this);" onpaste="return false;">
                            </div>
                        ...
                        <div class="row">
                          <div class="form-group col-sm-6 <?php echo (form_error("txtcedula")) ? 'has-error' : ''; ?>">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" id="cedula" name="txtcedula" value="<?php echo set_value("txtcedula") ?>" class="form-control" maxlength="10" onkeypress="return sololnumeros(event)" onpaste="return false;" onkeyup="validarDocumento();" placeholder="Cédula">
                            </div>
                          ...
                          <div class="form-group col-sm-6 <?php echo (form_error("txttelefono")) ? 'has-error' : ''; ?>">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" id="txttelefono" name="txttelefono" class="form-control" placeholder="Telefono" onkeypress="return sololnumeros(event)" onpaste="return false;">
                            </div>
                        ...
                        <div class="row">
                          <div class="form-group col-sm-6 <?php echo (form_error("txtemail")) ? 'has-error' : ''; ?>">
                            ...
                            <div class="input-group">
                              ...
                              <input type="email" id="txtemail" name="txtemail" value="<?php echo set_value("txtemail") ?>" class="form-control" placeholder="Email">
                            </div>
                          ...
                          <div class="form-group col-sm-6 <?php echo (form_error("txtdireccion")) ? 'has-error' : ''; ?>">
                            ...
                            <div class="input-group">
                              ...
                              <textarea type="textarea" name="txtdireccion" id="txtdireccion" class="form-control" value="<?php echo set_value("txtdireccion") ?>" placeholder="Dirección" onkeypress="return sololetras(event)" onpaste="return false;" onkeyup="mayus(this);"></textarea>
                            </div>
                      ...
                      <div class="tab-pane" id="tab_cuenta">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-sm-6 <?php echo (form_error("txtclave2")) ? 'has-error' : ''; ?>">
                            ...
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-info"></i></span>
                              <input type="password" name="txtclave2" id="txtclave2" class="form-control" placeholder="Repita Contraseña" onkeyup="validacion('txtclave2')">
                            </div>
